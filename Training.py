...
x_train = train_datagen.flow_from_directory('D:\PROJECTS\Brain Tumor Detection\Brain_Tumor_Dataset\Training',
                                            target_size=(224,224),
                                            class_mode = 'categorical',
                                            batch_size = 100)
# data augmentation on the testing data
x_test = test_datagen.flow_from_directory('D:\PROJECTS\Brain Tumor Detection\Brain_Tumor_Dataset\Testing',
                                            target_size=(224,224),
                                            class_mode = 'categorical',
                                            batch_size = 100)
# adding layers
